...
namespace Pinokio.Animation.User
{
    ...
    public class RefTree_1 : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public RefTree_1(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\Tree_1.obj", "RefTree_1", model);
