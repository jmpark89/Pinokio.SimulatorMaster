//------------------------------------------------------------------------------
// <auto-generated>12281_Container_v2_L2
...
namespace Pinokio.Animation.User
{
    ...
    public class RefContainer_v2_L2 : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public RefContainer_v2_L2(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\12281_Container_v2_L2.obj", "RefContainer_v2_L2", model);
