...
namespace Pinokio.Animation.User
{
    ...
    public class RefMinusCell : PartReference
    {

        public RefMinusCell(string blockName, SimObj entity) : base(blockName)
        {
            Core = entity;
        }

        public RefMinusCell(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\Minus_Cell_jt.obj", "RefMinusCell", model);
