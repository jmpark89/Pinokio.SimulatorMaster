...
namespace Pinokio.Animation.User
{
    ...
    public class RefMinusLiquid : PartReference
    {

        public RefMinusLiquid(string blockName, SimObj entity) : base(blockName)
        {
            Core = entity;
        }

        public RefMinusLiquid(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\Minus_Liquid_jt.obj", "RefMinusLiquid", model);
