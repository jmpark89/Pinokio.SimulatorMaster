...
namespace Pinokio.Animation.User
{
    ...
    public class RefAnodePunching : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefAnodePunching(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\4.anode_punching_jt.obj", "RefAnodePunching", model);
