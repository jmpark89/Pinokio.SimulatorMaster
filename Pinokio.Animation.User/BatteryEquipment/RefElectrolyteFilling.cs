...
namespace Pinokio.Animation.User
{
    ...
    public class RefElectrolyteFilling : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefElectrolyteFilling(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\6.electrolyte_filling_jt.obj", "RefElectrolyteFilling", model);
