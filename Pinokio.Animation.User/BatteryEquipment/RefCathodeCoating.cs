...
namespace Pinokio.Animation.User
{
    ...
    public class RefCathodeCoating : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefCathodeCoating(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\3.cathode_coating_jt.obj", "RefCathodeCoating", model);
