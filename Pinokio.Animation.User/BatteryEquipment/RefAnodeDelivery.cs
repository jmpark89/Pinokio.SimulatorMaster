...
namespace Pinokio.Animation.User
{
    ...
    public class RefAnodeDelivery : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefAnodeDelivery(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\1.Anode_Delivery_jt_1.obj", "RefAnodeDelivery", model);
