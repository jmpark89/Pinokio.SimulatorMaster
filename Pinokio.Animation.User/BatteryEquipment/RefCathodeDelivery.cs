...
namespace Pinokio.Animation.User
{
    ...
    public class RefCathodeDelivery : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefCathodeDelivery(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\1.cathode_Delivery_jt.obj", "RefCathodeDelivery", model);
