...
namespace Pinokio.Animation.User
{
    ...
    public class RefCathodePuncing : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefCathodePuncing(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\4.cathode_puncing_jt.obj", "RefCathodePuncing", model);
