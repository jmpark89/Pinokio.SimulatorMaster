...
namespace Pinokio.Animation.User
{
    ...
    public class RefSortAndPacking : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefSortAndPacking(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\10.sort_and_packing_jt.obj", "RefSortAndPacking", model);
