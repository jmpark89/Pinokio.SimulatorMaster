...
namespace Pinokio.Animation.User
{
    ...
    public class RefCathodeMixing : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefCathodeMixing(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\2.cathode_mixing_jt.obj", "RefCathodeMixing", model);
