...
namespace Pinokio.Animation.User
{
    ...
    public class RefAnodeCoating : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\3.anode_coating_jt.obj", "RefAnodeCoating", model);
