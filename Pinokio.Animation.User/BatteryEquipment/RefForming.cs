...
namespace Pinokio.Animation.User
{
    ...
    public class RefForming : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefForming(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\7.forming_jt.obj", "RefForming", model);
