...
namespace Pinokio.Animation.User
{
    ...
    public class RefTester : RefEquipment
    {
        public static bool IsInserted = true;

        public RefTester(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\chack.obj", "RefTester", model);
