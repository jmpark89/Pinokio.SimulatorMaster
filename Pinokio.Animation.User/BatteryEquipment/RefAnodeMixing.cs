...
namespace Pinokio.Animation.User
{
    ...
    public class RefAnodeMixing : NodeReference
    {
        ...
        public new static string[] UsableBaseSimNodeType =
    {
        ...
        public RefAnodeMixing(string blockName) : base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            try
            {
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\2.anode_mixing_jt.obj", "RefAnodeMixing", model);
