...
namespace Pinokio.Animation.User
{
    ...
    public class Refstreet1 : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public Refstreet1(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\street1.obj", "Refstreet1", model);
