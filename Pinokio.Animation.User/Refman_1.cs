...
namespace Pinokio.Animation.User
{
    ...
    public class Refman_1 : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public Refman_1(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\man_1.obj", "Refman_1", model);
