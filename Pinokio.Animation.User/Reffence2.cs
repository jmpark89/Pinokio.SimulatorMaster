...
namespace Pinokio.Animation.User
{
    ...
    public class Reffence2 : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public Reffence2(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\fence2.obj", "Reffence2", model);
