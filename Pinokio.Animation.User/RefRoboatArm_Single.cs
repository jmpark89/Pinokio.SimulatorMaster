...
namespace Pinokio.Animation.User
{
    ...
    public class RefRoboatArm_Single : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public RefRoboatArm_Single(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\RoboatArm_Single.obj", "RefRoboatArm_Single", model);
