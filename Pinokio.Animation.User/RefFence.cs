...
namespace Pinokio.Animation.User
{
    ...
    public class RefFence : NodeReference
    {
        
        // Is this object Inserted ?
        public static bool IsInserted = true;
        
        public RefFence(string blockName) : 
                base(blockName)
        {
        ...
        public static void CreateBlock(PinokioBaseModel model, params object[] objects)
        {
            ...
            {
                // Write your code here.
                Block block = NodeReference.LoadModelFile("C:\\Carlo\\Pinokio\\Pinokio.Asset\\3D\\Fence.obj", "RefFence", model);
